                                        ...
                                        {blog.publishedAt.length &&
                                            <div className='flex gap-4 items-center group text-sm '>
                                                {blog.publishedAt.map((platform) => {
                                                    return <Link key={platform.url} className=' text-xs flex items-center gap-2 hover:underline duration-500 ease-in-out bg-platinum dark:bg-onyx rounded-lg py-2  px-3' href={platform.url} target='_blank'>
                                                        {platform.platform}
